    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                scm {
                    connection.set("scm:git:git://github.com/DAKSHSEMWAL/RetrofitUploadKit.git")
                    developerConnection.set("scm:git:ssh://github.com/DAKSHSEMWAL/RetrofitUploadKit.git")
                    url.set("https://github.com/DAKSHSEMWAL/RetrofitUploadKit")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/DAKSHSEMWAL/RetrofitUploadKit/issues")
                }
            }
        }
    }
