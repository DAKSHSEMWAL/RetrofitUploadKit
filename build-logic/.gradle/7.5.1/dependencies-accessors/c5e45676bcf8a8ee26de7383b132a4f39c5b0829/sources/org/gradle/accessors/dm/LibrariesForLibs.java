...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxMaterial3LibraryAccessors getMaterial3() { return laccForAndroidxMaterial3LibraryAccessors; }
    ...
    public static class AndroidxMaterial3LibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxMaterial3LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() { return create("androidx.material3.android"); }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        private final ComposeDestinationLibraryAccessors laccForComposeDestinationLibraryAccessors = new ComposeDestinationLibraryAccessors(owner);

        public ComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at compose.destination
         */
        public ComposeDestinationLibraryAccessors getDestination() { return laccForComposeDestinationLibraryAccessors; }

    }

    public static class ComposeDestinationLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public ComposeDestinationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for destination (io.github.raamcosta.compose-destinations:core)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("compose.destination"); }

            /**
             * Creates a dependency provider for ksp (io.github.raamcosta.compose-destinations:ksp)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKsp() { return create("compose.destination.ksp"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: richeditor (0.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class AccompanistVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        private final AccompanistNavigationVersionAccessors vaccForAccompanistNavigationVersionAccessors = new AccompanistNavigationVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.accompanist.navigation
         */
        public AccompanistNavigationVersionAccessors getNavigation() { return vaccForAccompanistNavigationVersionAccessors; }

    }

    public static class AccompanistNavigationVersionAccessors extends VersionFactory  {

        public AccompanistNavigationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: accompanist.navigation.animation (0.30.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAnimation() { return getVersion("accompanist.navigation.animation"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        public AndroidxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidx.splashscreen (1.0.0-rc01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Returns the version associated to this alias: androidx.compose (1.3.2)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxNavVersionAccessors extends VersionFactory  {
        ...
        public AndroidxNavVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidx.nav.version (2.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        public ComposeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: compose.destination (1.7.41-beta)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getDestination() { return getVersion("compose.destination"); }
    ...
    public static class KotlinxCoroutinesVersionAccessors extends VersionFactory  {
        ...
        public KotlinxCoroutinesVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlinx.coroutines.test (1.6.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginVersionAccessors extends VersionFactory  {
        ...
        public PluginVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: plugin.kotlin (1.7.20)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class ProtobufVersionAccessors extends VersionFactory  {
        ...
        public ProtobufVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: protobuf.javalite (3.18.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
